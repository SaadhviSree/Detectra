...
def main():
    ...
    output_file = os.path.join(output_dir, f"{case_id}_report.json")  # Changed to .json
    
    if os.path.isdir(args.path):
        # It's a directory, process files directly
        ...
        # Process as disk image
        print(f"Processing disk image: {args.path}")
        disk = DiskImageManager(str(args.path))
